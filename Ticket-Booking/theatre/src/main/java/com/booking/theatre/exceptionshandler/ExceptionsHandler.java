package com.booking.theatre.exceptionshandler;

import com.booking.theatre.exceptions.*;
...
public class ExceptionsHandler {
    ...
    public ResponseEntity<Format> handleRestClientException(RestClientResponseException e){
        return new ResponseEntity<>(Format.builder().status(e.getResponseBodyAs(Format.class).getStatus()).message(e.getResponseBodyAs(Format.class).getMessage()).build(), HttpStatus.BAD_REQUEST);
    }
